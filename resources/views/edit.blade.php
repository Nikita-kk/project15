    ...
    @csrf
        <div class="form-row">
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" name="fname" value="{{$data->firstname}}" required>
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" name="lname" value="{{$data->lastname}}" required>
            <div class="valid-feedback">
              Looks good!
            </div>
          </div>
        ...
        <button class="btn btn-primary" type="submit">updateform</button>
      </form>
